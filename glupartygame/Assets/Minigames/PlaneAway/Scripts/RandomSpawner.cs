...
namespace PlaneAway
{
    public class RandomSpawner : MonoBehaviour
    {
        ...
        [SerializeField]
        private List<GameObject> m_activePlayerlist; public List<GameObject> playerList { get { return (m_activePlayerlist); } set { m_activePlayerlist = value; AdjustCooldowns(); } }
