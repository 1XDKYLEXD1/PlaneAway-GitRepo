...
public class Airplane : MonoBehaviour {
    ...
    private void PlayerFallForce()
    {
        for(int i =0; i < m_allGroundedPlayers.Count; i++)
        {
            ...
            {
                m_allGroundedPlayers[i].GetComponent<playermovement>()._extramomentum = m_playerFallSpeedAmplifier*
            ...
            {
                m_allGroundedPlayers[i].GetComponent<playermovement>()._extramomentum = 0;
            }
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            other.gameObject.GetComponent<playermovement>()._extramomentum = 0;
        }
    }
}
